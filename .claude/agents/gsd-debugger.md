...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/abhaykorlapati/Desktop/Assembli/.claude
                  → checks /Users/abhaykorlapati/Desktop/Assembli/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/abhaykorlapati/Desktop/Assembli/.claude/get-shit-done
                  → writes to /Users/abhaykorlapati/Desktop/Assembli/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/abhaykorlapati/Desktop/Assembli/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/abhaykorlapati/Desktop/Assembli/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/abhaykorlapati/Desktop/Assembli/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
