...
```bash
INIT=$(node "/Users/abhaykorlapati/Desktop/Assembli/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/abhaykorlapati/Desktop/Assembli/.claude/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
