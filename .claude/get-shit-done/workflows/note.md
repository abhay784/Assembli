...
- **Global scope**: `/Users/abhaykorlapati/Desktop/Assembli/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/abhaykorlapati/Desktop/Assembli/.claude/notes/`)
...
2. Glob `/Users/abhaykorlapati/Desktop/Assembli/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/abhaykorlapati/Desktop/Assembli/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/abhaykorlapati/Desktop/Assembli/.claude/notes/` — works in any directory
